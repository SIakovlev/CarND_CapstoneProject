...
class CnnClassifierModel():
    ...
    def add_custom_layers(self):
        ...
        dense_cw = tf.layers.dense(inputs=flat_cw, units=32, activation=tf.nn.relu, name="dense_cw") # number of units chosen not to exceed memory!
    ...
    def __init__(self, sess, load_trained_weights):
        ...
        self.image_shape = (8*32, 11*32) # Landscape format for full frames -- out of GPU memory trying 576*800, had to go sm6ller.
